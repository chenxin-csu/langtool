...
public class UploadServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            switch (type) {
                case STATS:
                    savePath += STATS + PATH_SPLITER;
                    break;
                case TRANS_WORDS:
                case TRANS_FILES:
                    savePath += TRANS + PATH_SPLITER;
                    break;
            }
            ...
            switch (type) {
                case TRANS_FILES:
                    ...
                    File wordsDir = new File(savePath + TRANS_WORDS + PATH_SPLITER);
            ...
            for (FileItem item : items) {
                if (!item.isFormField()) {
                    ...
                    if ((TRANS_WORDS).equals(type) && !item.getName().endsWith(".xlsx")) {
                    ...
                    if (TRANS_WORDS.equals(type)) {
                        ...
                        if (transFile == null) {
                            ...
                            detail.put("url", WORKSPACE_PATH + PATH_SPLITER + request.getSession(true).getId() + PATH_SPLITER + TRANS + PATH_SPLITER + TRANS_FILES + PATH_SPLITER
                                    + DONE_PATH + PATH_SPLITER + transFile.getName());
                        }
            ...
            if (!hasError && TRANS_WORDS.equals(type)) {
